...
public class mectel extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.aprilfool", "com.htetznaing.aprilfool.mectel");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.aprilfool", "com.htetznaing.aprilfool.mectel");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.aprilfool.mectel", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._tlb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 36;BA.debugLine="tlb.Text = \"MecTel\"";
mostCurrent._tlb.setText(BA.ObjectToCharSequence("MecTel"));
...
mostCurrent._a1._initialize(mostCurrent.activityBA,"a1",mectel.getObject(),(int) (500));
