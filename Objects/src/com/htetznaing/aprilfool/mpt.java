...
public class mpt extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.aprilfool", "com.htetznaing.aprilfool.mpt");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.aprilfool", "com.htetznaing.aprilfool.mpt");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.aprilfool.mpt", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._tlb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 36;BA.debugLine="tlb.Text = \"MPT\"";
mostCurrent._tlb.setText(BA.ObjectToCharSequence("MPT"));
...
mostCurrent._a1._initialize(mostCurrent.activityBA,"a1",mpt.getObject(),(int) (500));
